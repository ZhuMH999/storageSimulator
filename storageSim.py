    ...
    def handle_boxes(self, playerx, playery, player):
        ...
        if not self.boxes_to_spawn and not self.boxes_to_take:
            ...
            if mode == 'Normal':
                ...
                if (temp == 0 or temp == 1) and len(self.box) >= 2:
...
class Player:
    def __init__(self, boxes):
        ...
        self.direction = None
        self.current_map = 0
        self.money = 
